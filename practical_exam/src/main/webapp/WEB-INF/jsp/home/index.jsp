...
<script>
	...
	window.onload = function() {
		...
		lineChart('userAvgLineChart', '과목별 회원 평균 점수와 사용자의 평균 점수', [1,2,3,4,5],'ㅇㅇㅇ님', '회원 평균', [1,3,2,4,6],[1,2,5,3,4])
	}
...
<body>
	<div id="dashboard">
		<div id ="menuHeader">
			<h2>Dashboard</h2>
			<span id="userInfo">ㅇㅇㅇ님 합격률 N %</span> <!-- 최근 5번의 시험으로 60점 이상을 받은 데이터로 계산. 0건인 경우, 확인이 필요 -->
